...
class Unit{
    ...
    build(building, coords){
        if(coordsTouching(this.coord, coords)){

        }
        if (!this.canAffordBuild(building)){
    ...
    canAffordBuilding(building){
        if (this.owner === "player"){
            if(controller.player.resources.food >= building.resources.food && controller.player.resources.gold > building.resources.gold){
                return true;
            }
        }

        if (this.owner === "computer"){
            if(controller.computer.resources.food >= building.resources.food && controller.computer.resources.gold > building.resources.gold){
                return true;
            }
        }
